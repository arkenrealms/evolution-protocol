...
- Top-level `where.AND` / `where.OR` compatibility for both single-object and array forms.
- Exported `Query` schema acceptance of single-object `where.AND` / `where.OR` forms.
