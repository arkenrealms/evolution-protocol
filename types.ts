...
import type { Router as ShardRouter } from './shard/server';
...
export interface RealmApplication {
  ...
  version: string;
  endpoint: string;
  rooms: Record<string, ShardServer>;
...
export class ShardServer {
  ...
  endpoint: string;
  key: string;
  bridge?: ReturnType<typeof createTRPCProxyClient<ShardRouter>>;
...
export interface ShardApplication {
  io: any;
  state: any;
